...
`;var w=(o=>(o.New="new",o.Done="done",o.Warn="warn",o.Error="error",o.ViewOnly="viewOnly",o))(w||{});function ke(o,e){if(e.viewOnly)return{iconState:"viewOnly",collidingTagIds:[]};const i=o.userData.sourceDetails.find(n=>n.id===e.id)?.selectedTags??[];if(i.length===0)return{iconState:"new",collidingTagIds:[]};const s=e.colisionMode??D.None;if(s===D.None)return{iconState:"done",collidingTagIds:[]};const r=new Set;for(const n of o.userData.sourceDetails){if(n.id===e.id)continue;const l=o.sourceDetails.find(a=>a.id===n.id);if(l&&l.selectionId===e.selectionId)for(const a of n.selectedTags)i.includes(a)&&r.add(a)}return r.size===0?{iconState:"done",collidingTagIds:[]}:{iconState:s===D.Error?"error":"warn",collidingTagIds:Array.from(r)}}function nt(o,e){return ke(o,e).iconState}function at(o,e){const t=o.userData.sourceDetails.find(s=>s.id===e.id)?.selectedTags??[],i=o.selections.find(s=>s.id===e.selectionId);return t.map(s=>i?.tags.find(r=>r.id===s)?.value??s)}function lt(o,e){if(e.dependencyLinks.length===0)return[];const t=(r,n)=>r.configuration.sourceDetails.find(a=>X(r.moduleId,a.id)===n||a.id===n)?.selectionId??r.configuration.sourceDetailsSettings?.selectionId,i=(r,n,l)=>{const a=t(r,n);return a?(o.dependencyData??[]).find(d=>d.moduleType===P.Selection&&d.moduleId===a)?.configuration.tags.find(d=>d.id===l)?.value:void 0},s=[];for(const r of e.dependencyLinks)for(const n of(o.dependencyData??[]).filter(l=>l.moduleType===P.Swt)){const l=n.userData.sourceDetails.find(a=>a.id===r);if(l)for(const a of l.selectedTags)s.push(i(n,l.id,a.tagId)??a.tagId)}return s}function ct(o,e,t){return o.sourceDetails.map(i=>dt({uiModel:o,item:i,onSelect:e,onKeydown:t}))}function dt(o){const{uiModel:e,item:t,onSelect:i,onKeydown:s}=o,r=Number(t.position?.x??0),n=Number(t.position?.y??0),l=60,a=nt(e,t),c=a===w.ViewOnly,d={[w.New]:tt,[w.Done]:st,[w.Warn]:it,[w.Error]:ot,[w.ViewOnly]:rt};return b`
  ...
  `}function ht(o){return o.sourceDetails.flatMap(e=>{const t=at(o,e),i=lt(o,e);if(t.length===0&&i.length===0)return[];const s=Number(e.position?.x??0),r=Number(e.position?.y??0),l=(e.tagBoxSide??"right")==="left",a=e.tagBoxMode==="selectedOnly"&&!e.viewOnly,c=l?-105:1,d=`swt__tag-box ${l?"swt__tag-box--left":""} ${a?"swt__tag-box--top-only":""}`;return[b`
        <foreignObject
          x=${s}
          y=${r}
          width="1"
        ...
        >
          <div class=${d}>
            ...
            ${a?g:f`<div class="swt__tag-bottom"><span>${i[0]||""}</span></div>`}
          </div>
        </foreignObject>
      `]})}function ut(o){const{configuration:e,uiModel:t,onStageClick:i,onSelect:s,onKeydown:r,onImgLoad:n,onModalClose:l,onTagSelect:a}=o,c=t.imgWidth>0?t.imgWidth:0,d=t.imgHeight>0?t.imgHeight:0;return f`
    <div class="swt">
      ${e.source?f`<img
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const F=o=>(e,t)=>{t!==void 0?t.addInitializer(()=>{customElements.define(o,e)}):customElements.define(o,e)};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */function mt({context:o,subscribe:e}){return(t,i)=>{typeof i=="object"?i.addInitializer((function(){new Te(this,{context:o,callback:s=>{t.set.call(this,s)},subscribe:e})})):t.constructor.addInitializer((s=>{new Te(s,{context:o,callback:r=>{s[i]=r},subscribe:e})}))}}const Me="swt-ui-model-context";class R{constructor(e){this.id=e.id,this.selectedTags=[...e.selectedTags]}hasTag(e){return this.selectedTags.includes(e)}addTag(e){return this.hasTag(e)?this:new R({id:this.id,selectedTags:[...this.selectedTags,e]})}removeTag(e){return this.hasTag(e)?new R({id:this.id,selectedTags:this.selectedTags.filter(t=>t!==e)}):this}}class G{constructor(e,t){this.id=X(t,e.id),this.source=e.source,this.position=e.position,this.name=e.name,this.type=e.type,this.selectionId=e.selectionId,this.colisionMode=e.colisionMode,this.dependencyLinks=G.toCompositeKeys(e.dependencyLinks),this.tagBoxSide=e.tagBoxSide??"right",this.tagBoxMode=e.tagBoxMode??"both",this.viewOnly=e.viewOnly??!1}static toCompositeKeys(e){return(e??[]).map(t=>X(t.moduleId,t.sourceDetailId))}getDependencyLinksCompositeKeys(){return this.dependencyLinks??[]}}class vt{constructor(e){this.id=e.moduleId,this.tags=e.configuration.tags,this.mode=e.configuration.mode,this.maxSelectedTags=e.configuration.maxSelectedTags??0,this.highlightSelectedTags=e.configuration.highlightSelectedTags??!1}}var yt=Object.defineProperty,xt=Object.getOwnPropertyDescriptor,C=(o,e,t,i)=>{for(var s=i>1?void 0:i?xt(e,t):e,r=o.length-1,n;r>=0;r--)(n=o[r])&&(s=(i?n(e,t,s):n(s))||s);return i&&s&&yt(e,t,s),s};h.SourceWorkTool=class extends k{constructor(){super(),this.exportVersion=1,this.configuration={...et},this.dependencyData=[],this.userData={},this.lang="cs",this.readOnly=!1,this._uiModel={...h.SourceWorkTool._EMPTY_UI_MODEL},this._rebuildRecords()}_setUiModel(e){this._uiModel={...this._uiModel,...e}}_rebuildRecords(){const e=this.configuration.moduleId??"local",t=this.configuration.sourceDetailsSettings,i=this.configuration.sourceDetails.map(r=>{if(!t)return new G({...r,colisionMode:r.colisionMode??D.None},e);const n={...r,name:r.name??t.name,type:r.type??t.type,selectionId:r.selectionId??t.selectionId,tagBoxMode:r.tagBoxMode??t.tagBoxMode,colisionMode:r.colisionMode??t.colisionMode??D.None};return new G(n,e)}),s=(this.dependencyData??[]).filter(r=>r.moduleType===P.Selection).map(r=>new vt(r));this._uiModel={...this._uiModel,sourceDetailsSettings:this.configuration.sourceDetailsSettings,selections:s,sourceDetails:i,dependencyData:this.dependencyData??[]}}_handleSelect(e){const t=this._uiModel.selectedId===e?null:e;this._setUiModel({selectedId:t,modalOpen:t!==null})}_handleKeydown(e,t){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this._handleSelect(t))}_handleModalClose(){this._setUiModel({selectedId:null,modalOpen:!1}),this.dispatchEvent(new CustomEvent("swt:change",{bubbles:!0,composed:!0,detail:{exportModule:this.exportModule()}}))}_handleTagSelect(e){const t=this._uiModel.selectedId;if(!t)return;const s=this._uiModel.userData.sourceDetails.find(_=>_.id===t)??new R({id:t,selectedTags:[]}),r=s.selectedTags,n=r.includes(e),l=this._uiModel.sourceDetails.find(_=>_.id===t),c=this._uiModel.selections.find(_=>_.id===l?.selectionId)?.maxSelectedTags;let d;n?d=s.removeTag(e):c===1?d=new R({id:t,selectedTags:[e]}):typeof c=="number"&&c>0&&r.length>=c?d=s:d=s.addTag(e);const u=this._uiModel.userData.sourceDetails.filter(_=>_.id!==t);d.selectedTags.length>0&&u.push(d),this._setUiModel({userData:{sourceDetails:u}})}_updateResponsiveMaxWidth(e,t){if(e<=0||t<=0)return;const i=e/t,r=(Math.min(.9,Math.max(.45,i))-.45)/(.9-.45),n=Math.round(15+r*10);this.style.setProperty("--swt-max-width-units",String(n))}_handleImgLoad(e){const t=e.target;this._updateResponsiveMaxWidth(t.naturalWidth,t.naturalHeight),this._setUiModel({imgWidth:t.naturalWidth,imgHeight:t.naturalHeight})}_handleStageClick(e){if(!this.configuration.debug)return;console.log("[SWT debug] Stage click event:",e);const t=e.currentTarget;if(!t)return;const i=t.getScreenCTM();if(!i)return;const s=t.createSVGPoint();s.x=e.clientX,s.y=e.clientY;const r=s.matrixTransform(i.inverse()),n=Math.round(r.x),l=Math.round(r.y);console.log("[SWT debug] SVG click:",{x:n,y:l})}updated(){if(this._uiModel.imgWidth>0)return;const e=this.shadowRoot?.querySelector(".swt__bg");e?.complete&&e.naturalWidth>0&&(this._updateResponsiveMaxWidth(e.naturalWidth,e.naturalHeight),this._setUiModel({imgWidth:e.naturalWidth,imgHeight:e.naturalHeight}))}willUpdate(e){if(e.has("configuration")&&this._rebuildRecords(),e.has("dependencyData")&&this._setUiModel({dependencyData:this.dependencyData??[]}),e.has("userData")){const t=(this.userData?.sourceDetails??[]).map(i=>new R({id:i.id,selectedTags:i.selectedTags.map(s=>s.tagId)}));this._setUiModel({userData:{sourceDetails:t}})}e.has("readOnly")&&this._setUiModel({isReadOnly:this.readOnly})}exportUserData(){return{sourceDetails:this._uiModel.userData.sourceDetails.map(t=>({id:t.id,recordType:Qe.SourceDetail,selectedTags:t.selectedTags.map(i=>({tagId:i}))}))}}exportModule(){const e=this.configuration.moduleId??"local";return{version:this.exportVersion,moduleId:e,configuration:{...this.configuration},moduleType:P.Swt,updatedAt:new Date().toISOString(),userData:this.exportUserData()}}render(){return ut({configuration:this.configuration,uiModel:this._uiModel,imgWidth:this._uiModel.imgWidth,imgHeight:this._uiModel.imgHeight,selectedId:this._uiModel.selectedId,onStageClick:e=>this._handleStageClick(e),onSelect:e=>this._handleSelect(e),onKeydown:(e,t)=>this._handleKeydown(e,t),onImgLoad:e=>this._handleImgLoad(e),onModalClose:()=>this._handleModalClose(),onTagSelect:e=>this._handleTagSelect(e)})}},h.SourceWorkTool.styles=Ge,h.SourceWorkTool._EMPTY_UI_MODEL={sourceDetails:[],selections:[],dependencyData:[],isReadOnly:!1,reviewData:[],userData:{sourceDetails:[]},selectedId:null,modalOpen:!1,imgWidth:0,imgHeight:0},C([p({attribute:!1})],h.SourceWorkTool.prototype,"configuration",2),C([p({attribute:!1})],h.SourceWorkTool.prototype,"dependencyData",2),C([p({attribute:!1})],h.SourceWorkTool.prototype,"userData",2),C([p({attribute:"data-lang"})],h.SourceWorkTool.prototype,"lang",2),C([p({type:Boolean,reflect:!0})],h.SourceWorkTool.prototype,"readOnly",2),C([wt({context:Me}),ft()],h.SourceWorkTool.prototype,"_uiModel",2),h.SourceWorkTool=C([F("source-work-tool")],h.SourceWorkTool);var $t=Object.defineProperty,kt=Object.getOwnPropertyDescriptor,y=(o,e,t,i)=>{for(var s=i>1?void 0:i?kt(e,t):e,r=o.length-1,n;r>=0;r--)(n=o[r])&&(s=(i?n(e,t,s):n(s))||s);return i&&s&&$t(e,t,s),s};let m=class extends k{constructor(){super(...arguments),this.selection=null,this.selectedTagIds=[],this.sharedSelectedTagIds=[],this.maxSelectedTags=null,this.highlightSelectedTags=!0,this.collisionState=w.New,this.collidingTagIds=[],this.isReadOnly=!1}_onTagClick(o){this.isReadOnly||this.dispatchEvent(new CustomEvent("swt-tag-selection:select",{detail:{tagId:o.id},bubbles:!0,composed:!0}))}_renderSelected(){const o=this.selectedTagIds.map(e=>this.selection?.tags.find(t=>t.id===e)).filter(e=>e!==void 0);return f` <div class="tag-selection__label">Vybráno</div>
  ...
  `,v([p({type:String})],h.SwtSelection.prototype,"label",2),v([p({attribute:!1})],h.SwtSelection.prototype,"dependencies",2),v([p({attribute:!1})],h.SwtSelection.prototype,"tags",2),v([p({type:String})],h.SwtSelection.prototype,"mode",2),v([p({type:Number,attribute:"max-selected-tags"})],h.SwtSelection.prototype,"maxSelectedTags",2),v([p({type:Boolean,attribute:"highlight-selected-tags"})],h.SwtSelection.prototype,"highlightSelectedTags",2),v([p({attribute:!1})],h.SwtSelection.prototype,"selectedTagIds",2),v([p({attribute:!1})],h.SwtSelection.prototype,"sharedSelectedTagIds",2),v([p({type:Boolean})],h.SwtSelection.prototype,"isReadOnly",2),h.SwtSelection=v([F("swt-selection")],h.SwtSelection),h.ColisionType=D,h.SourceDetailType=$e,h.SourceFunction=xe,Object.defineProperty(h,Symbol.toStringTag,{value:"Module"}),h})({});
